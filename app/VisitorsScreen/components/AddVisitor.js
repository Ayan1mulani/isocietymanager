...
const AddVisitor = ({ navigation }) => {
  ...
  const getHeaderTitle = () => {
    ...
    if (type === "guest") return t("Invite Guest");
    if (type === "delivery") return t("Schedule Delivery");
    if (type === "cab") return t("Book Cab Entry");
    if (type === "others") return t("Add Visitor");

    return t("Add Visitor");
  };

  const getHeaderSubtitle = () => {
    if (visitorType === "others") return t("Allow trusted services to visit");
    if (visitorType === "delivery") return t("Schedule delivery entry");
    if (visitorType === "cab") return t("Manage cab entries");
    return t("Schedule a guest visit");
  };
