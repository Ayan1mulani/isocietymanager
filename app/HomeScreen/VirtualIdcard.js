...
const styles = StyleSheet.create({
  ...
  avatarRing: { padding: scale(3), borderRadius: scale(70), borderWidth: scale(2.5), borderColor: "#1996D3" },
  ...
  orangeUserId: { fontSize: scale(13), fontWeight: "800", color: "#EA580C", marginTop: scale(3) },
  ...
  typeTagContainer: { backgroundColor: "#E0F2FE", borderWidth: 1, borderColor: "#BAE6FD" },
  typeTagText: { fontSize: scale(11), color: "#0369A1", fontWeight: "800" },
  ...
  iconCircle: { width: scale(32), height: scale(32), borderRadius: scale(16), backgroundColor: "#EFF6FF", justifyContent: "center", alignItems: "center" },
